...
//    }
    ...
    private void saveWindowConfiguration() {
        config.saveWindowState(MAIN_WINDOW_ID, getBounds(), getExtendedState());
    ...
    private void restoreWindowConfiguration() {
        ...
        if (mainState != null) {
            setBounds(mainState.getSize());
            setExtendedState(mainState.getExtendedState());
        }
        ...
        for (JInternalFrame frame : desktopPane.getAllFrames()) {
            ...
            if (windowState != null) {
                frame.setBounds(windowState.getSize());
